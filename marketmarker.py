...
class MarketMaker :
    ...
    def generate_order_params(self, initial_price=2.0, default_quantity=1) :
        ...
        buy_request.validate(mintrade_amnt, maxtrade_amnt)
        ...
        sell_request.validate(mintrade_amnt, maxtrade_amnt)
        resp.sell_request = sell_request

        return resp 

    def execute_buy_order(self, req : OrderRequest) :
